package com.haishi.LittleRedBook.search.biz.canal;

import com.alibaba.otter.canal.client.CanalConnector;
import com.alibaba.otter.canal.protocol.CanalEntry;
import com.alibaba.otter.canal.protocol.Message;
import com.google.common.collect.Maps;
import com.haishi.LittleRedBook.search.biz.config.canal.CanalProperties;
import com.haishi.LittleRedBook.search.biz.enums.NoteStatusEnum;
import com.haishi.LittleRedBook.search.biz.enums.NoteVisibleEnum;
...
public class CanalSchedule implements Runnable {
     ...
     * @param entries
     */
    private void printEntry(List<CanalEntry.Entry> entries) throws Exception {
