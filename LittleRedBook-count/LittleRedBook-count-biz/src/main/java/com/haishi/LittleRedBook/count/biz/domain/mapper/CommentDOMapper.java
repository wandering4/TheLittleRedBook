...
import com.haishi.LittleRedBook.count.biz.domain.dataobject.CommentDO;
...
public interface CommentDOMapper {
     ...
     * @return
     */
    int updateLikeTotalByCommentId(@Param("count") Integer count, @Param("commentId") Long commentId);
