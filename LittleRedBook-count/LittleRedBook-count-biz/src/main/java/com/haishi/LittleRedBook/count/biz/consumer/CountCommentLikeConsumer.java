...
import com.haishi.LittleRedBook.count.biz.enums.LikeUnlikeCommentTypeEnum;
import com.haishi.LittleRedBook.count.biz.model.dto.AggregationCountLikeUnlikeCommentMqDTO;
import com.haishi.LittleRedBook.count.biz.model.dto.CountLikeUnlikeCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "LittleRedBook_group_count_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE, // Group 组
...
public class CountCommentLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        countList.forEach(item -> {
            ...
            boolean isCountCommentExisted = Boolean.TRUE.equals(redisTemplate.hasKey(countCommentRedisKey));
